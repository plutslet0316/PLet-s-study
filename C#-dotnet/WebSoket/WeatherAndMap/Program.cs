    ...
    class Program
    {
        ...
        class WeatherAndMap{
            ...
            public void GetMap(){
                    ...
                    map.DefaultRequestHeaders.Add("X-NCP-APIGW-API-KEY-ID", "네이버_API_Key_Id");  // 네이버 API Key Id
                    map.DefaultRequestHeaders.Add("X-NCP-APIGW-API-KEY", "네이버_API_Key");  // 네이버 API Key
            ...
            public string GetWeather(){
                ...
                // 기상청 API KEY
                var ApiKey = "기상청_API_KEY";

                // 기상청의 초단기 실황 가져오기
                var Url = $"http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?serviceKey={ApiKey}&numOfRows=10&dataType=JSON&pageNo=1";
